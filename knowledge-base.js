            ...
            critical: [
                {
                    ...
                    detailedActions: [
                        {
                            title: 'NAP情報の完全統一',
                            description: '店舗名・住所・電話番号をHP、SNS、Googleビジネスプロフィールで完全に一致させます。全角・半角・ハイフンの有無まで統一することがポイントです。',
                            immediateSteps: [
                                '今日：Googleビジネスプロフィールにログインし、現在の登録情報を確認',
                                '今日：HPに記載の住所・電話番号をコピーし、Googleに貼り付けて完全一致させる',
                                '今週中：SNS（Instagram、Facebook等）のプロフィール欄も同じ情報に統一'
                            ],
                            tools: 'Googleビジネスプロフィール管理画面、HP管理画面',
                            tip: '「○○歯科」と「○○歯科医院」など、微妙な表記の違いも統一してください'
                        },
                        {
                            title: '写真の毎週アップロード習慣化',
                            description: '院内の雰囲気やスタッフの顔がわかる写真を週1回以上（理想は毎日）アップロードします。',
                            immediateSteps: [
                                '今日：スマホで待合室・診療室・スタッフの写真を5枚撮影',
                                '今日：Googleビジネスプロフィールの「写真を追加」から投稿',
                                '毎週月曜：「写真投稿日」を設定し、カレンダーに登録',
                                '撮影担当者を決める（受付スタッフ等）'
                            ],
                            tools: 'スマートフォン、Googleビジネスプロフィールアプリ',
                            tip: '笑顔のスタッフ写真は患者に安心感を与え、特に効果的です'
                        },
                        {
                            title: '投稿機能での定期配信',
                            description: '季節のお知らせ・症例紹介・スタッフ紹介などを週1回投稿し、アクティブな医院であることをアピールします。',
                            immediateSteps: [
                                '今日：「投稿を作成」から最新のお知らせ（診療時間、キャンペーン等）を投稿',
                                '今週中：投稿カレンダーを作成（例：月曜＝診療情報、木曜＝スタッフ紹介）',
                                '来週：症例紹介の投稿テンプレートを作成'
                            ],
                            tools: 'Googleビジネスプロフィール投稿機能、Canva（画像作成）',
                            tip: '「インプラント」「矯正」など強化したい治療のキーワードを投稿に含めると検索にヒットしやすくなります'
                        }
                    ]
                },
                {
                    ...
                    detailedActions: [
                        {
                            title: 'QRコード付きチラシの作成・設置',
                            description: '各ユニット・待合室・トイレにQRコード付きチラシを設置し、患者が直接Googleの口コミ投稿ページへアクセスできるようにします。',
                            immediateSteps: [
                                '今日：Googleビジネスプロフィールの「口コミを増やす」から短縮URLを取得',
                                '今日：QRコード生成サイト（QRのススメ等）でQRコード画像を作成',
                                '今週中：A5サイズのチラシをデザイン（「ご感想をお聞かせください」＋QRコード）',
                                '来週：各ユニット横、待合室、トイレの3箇所に設置'
                            ],
                            tools: 'QRコード生成サイト、Canva、印刷機',
                            tip: '「痛くなかった」「説明が丁寧だった」など具体的なキーワードを入れてほしい旨を小さく記載すると効果的です'
                        },
                        {
                            title: '口コミ依頼トークスクリプトの作成・練習',
                            description: 'スタッフ全員が自然に口コミ依頼できるよう、トークスクリプトを作成し練習します。',
                            immediateSteps: [
                                '今日：依頼タイミングを決定（治療完了時、メンテナンス移行時、自費治療終了時）',
                                '今週中：トークスクリプト作成「本日の治療はいかがでしたか？もしよろしければ、Googleで感想をお聞かせいただけると嬉しいです」',
                                '来週のミーティング：スタッフ全員でロールプレイング',
                                '1ヶ月後：依頼数と口コミ獲得数を集計し効果測定'
                            ],
                            tools: 'スクリプト用紙、ミーティング時間',
                            tip: '治療後の満足度が高いタイミング（痛みが取れた時、自費治療完了時等）に依頼すると高評価をもらいやすいです'
                        },
                        {
                            title: '全件24時間以内返信の習慣化',
                            description: '低評価・高評価問わず全ての口コミに24時間以内に丁寧に返信。返信内容を見た潜在患者への好印象にもつながります。',
                            immediateSteps: [
                                '今日：過去の未返信口コミに全て返信',
                                '今日：返信担当者を決定（院長 or 受付スタッフ）',
                                '毎日：朝の業務開始時に口コミチェック→即返信のルーティン化',
                                '低評価への返信テンプレート作成「この度はご不快な思いをおかけし申し訳ございません。今後の改善に活かして参ります」'
                            ],
                            tools: 'Googleビジネスプロフィールアプリ（通知設定ON）、ChatGPT（返信文作成支援）',
                            tip: '低評価への誠実な返信は、それを見た他の患者に「この医院は真摯に対応してくれる」という安心感を与えます'
                        }
                    ]
                }
            ],
            ...
            low: [
                {
                    ...
                    detailedActions: [
                        {
                            title: 'ブログ投稿の習慣化（週1〜2回）',
                            description: '患者が検索しそうなキーワードを意識した1,500文字以上のブログを継続投稿します。',
                            immediateSteps: [
                                '今日：検索されそうなキーワードをリストアップ（例：〇〇市 インプラント 費用、親知らず 抜くべき理由）',
                                '今週中：ChatGPTでブログ構成案を3本作成',
                                '来週：院長が専門家視点で精査・加筆し、1本目を投稿',
                                '第5週の診療時間（14〜15時の1時間予約カット）をブログ執筆時間に充てる'
                            ],
                            tools: 'ChatGPT、Wordpress/HPのブログ機能、Googleキーワードプランナー',
                            tip: '「地域名＋治療名」のキーワードで上位表示されると、治療意欲の高い患者が集まります'
                        },
                        {
                            title: '院長紹介ページの刷新',
                            description: '経歴だけでなく、治療への想い・人柄・趣味が伝わる内容に刷新し、「この先生に診てもらいたい」という指名来院を増やします。',
                            immediateSteps: [
                                '今日：院長の治療に対する想いを500文字程度で書き出す',
                                '今週中：プロフィール写真を笑顔で撮り直す',
                                '来週：趣味や休日の過ごし方も追記し、親しみやすさをアピール',
                                '患者様の「喜びの声」も同ページに掲載'
                            ],
                            tools: 'HPのCMS、カメラ（スマホ可）',
                            tip: '地域密着型では院長の顔が覚えられることで信頼関係が築きやすくなります'
                        },
                        {
                            title: '症例ブログの作成',
                            description: '主訴・悩み・治療期間・費用を明記し、Before/After写真を掲載した症例ブログを作成します。',
                            immediateSteps: [
                                '今日：過去1ヶ月で印象的だった症例を3件ピックアップ',
                                '今週中：患者様の許可を得て口腔内写真を使用可能か確認',
                                '来週：1件目の症例ブログを投稿（主訴→治療計画→経過→結果の流れ）',
                                '費用は必ず明記し、透明性をアピール'
                            ],
                            tools: '口腔内カメラ、同意書、HPのブログ機能',
                            tip: '患者様が自分と同じ悩みの症例を見ると「ここなら治せる」と安心して来院されます'
                        }
                    ]
                },
                {
                    ...
                    detailedActions: [
                        {
                            title: 'WEB予約ボタンの最適配置',
                            description: 'HPのファーストビュー（最初に見える位置）に目立つ予約ボタンを設置し、予約の取りこぼしを防ぎます。',
                            immediateSteps: [
                                '今日：自院HPをスマホで確認し、予約ボタンの見つけやすさをチェック',
                                '今週中：ファーストビューに「WEB予約はこちら」ボタンを追加（色は目立つ赤やオレンジ）',
                                '来週：スマホ表示でも問題なくタップできるかテスト',
                                'アポイント帳に「新患・急患専用枠」を毎日2〜3枠確保'
                            ],
                            tools: 'HP管理画面、WEB予約システム（EPARK、デンタルネット等）',
                            tip: '「今日診てほしい」という新患を「予約がいっぱい」と断ることは最大の機会損失です'
                        },
                        {
                            title: '初診枠のリアルタイム開放',
                            description: '初診枠を患者が直接予約できるようにし、DH枠でも受け入れられるように設定変更します。',
                            immediateSteps: [
                                '今日：現在のWEB予約システムで初診枠が開放されているか確認',
                                '今週中：DH枠でも「初診対応可」に設定変更',
                                '予約メニューを「痛みなし・検診希望」「痛みあり・急ぎ」など入口を広げる',
                                '来週：テスト予約を入れてスムーズに動作するか確認'
                            ],
                            tools: 'WEB予約システム管理画面',
                            tip: '予約枠が埋まっている場合はキャンセル待ちリストへの登録を促しましょう'
                        },
                        {
                            title: 'LINE予約との連携構築',
                            description: 'LINE公式アカウントと予約システムを連携し、より手軽な予約動線を作ります。',
                            immediateSteps: [
                                '今日：LINE公式アカウントを開設（未開設の場合）',
                                '今週中：リッチメニューに「予約」ボタンを追加',
                                '来週：WEB問診をネット予約完了後のメールやLINEに添付する設定',
                                '患者様の来院時にLINE登録を促し、リスト化'
                            ],
                            tools: 'LINE公式アカウント、予約システム連携機能',
                            tip: 'LINE登録者には次回予約リマインドやキャンペーン情報を送れるため、リピート率向上にも効果的です'
                        }
                    ]
                }
            ],
            ...
            critical: [
                {
                    ...
                    priority: 'highest',
                    steps: [
                        '①初診カウンセリング：潜在的な不安・理想をヒアリング',
                        '②セカンドカウンセリング：「なぜ悪くなったか」を視覚的に説明',
                        '③補綴コンサル：「松・竹・梅」3パターンの見積書提示'
                    ],
                    ...
                    detailedActions: [
                        {
                            title: '初診カウンセリングの仕組み化',
                            description: '主訴だけでなく、患者様の潜在的な不安・理想の状態・過去の歯科治療での不満を徹底的にヒアリングします。',
                            immediateSteps: [
                                '今日：初診カウンセリング用のヒアリングシートを作成（主訴、理想の状態、過去の不満、予算感）',
                                '今週中：専用カウンセリングスペースを確保（個室またはパーテーション）',
                                '来週のミーティング：ヒアリングのロールプレイング実施',
                                '患者様の言葉を「オウム返し」する練習で共感力を高める'
                            ],
                            tools: 'ヒアリングシート、カウンセリングスペース',
                            tip: 'この段階では「自費を勧める」のではなく、信頼の架け橋を築くことに専念してください'
                        },
                        {
                            title: 'セカンドカウンセリングの実施',
                            description: '2回目の来院時に30分程度の時間を確保し、「なぜ悪くなったか」「放置するとどうなるか」を視覚的に説明します。',
                            immediateSteps: [
                                '今日：セカンドカウンセリング用の予約枠（30分）を設定',
                                '今週中：口腔内写真・パノラマを使った説明資料を準備',
                                '「将来観測」資料を作成（放置した場合の最悪シナリオを図解）',
                                '「松・竹・梅」3パターンの見積書テンプレートを作成'
                            ],
                            tools: '大型モニター（40インチ以上推奨）、口腔内写真、見積書テンプレート',
                            tip: '患者様は真ん中のランクを選びやすい心理（ゴルディロックス効果）を活用し、最も推奨したいプランを「竹」に設定'
                        },
                        {
                            title: '終了コンサル（ファン化）の実施',
                            description: '自費治療終了時にBefore/After比較を見せ、高い満足度で紹介カード・口コミを依頼します。',
                            immediateSteps: [
                                '今日：治療前後の比較写真を撮影するルールを設定',
                                '今週中：終了コンサル用の流れを文書化（振り返り→メンテナンス説明→紹介カード→口コミ依頼）',
                                '花束やメッセージカードを用意し感動演出を準備',
                                '紹介カードと口コミQRコードを入れた「終了パック」を作成'
                            ],
                            tools: '口腔内カメラ、比較写真用フォルダ、紹介カード、花束',
                            tip: '満足度が最も高いこのタイミングで紹介と口コミを依頼すると成功率が格段に上がります'
                        }
                    ]
                },
                {
                    ...
                    steps: [
                        ...
                        '補綴模型を直接触ってもらい素材の価値を体感',
                        '「お口の状態解説書」を印刷し自宅で家族と相談可能に'
                    ],
                    ...
                    detailedActions: [
                        {
                            title: '大型モニターの設置と活用',
                            description: '40インチ以上の大型モニターを使用し、口腔内写真やパノラマを詳細に見せて「見える化」します。',
                            immediateSteps: [
                                '今日：各ユニットのモニター状況を確認（サイズ、映り具合）',
                                '今週中：40インチ以上のモニターを発注（1台3〜5万円程度）',
                                '来週：口腔内カメラとモニターの接続テスト',
                                'モニターの角度を患者様が見やすい位置に調整'
                            ],
                            tools: '大型モニター（40インチ以上）、口腔内カメラ、HDMI接続',
                            tip: '患者様は自分の口の中を初めてまじまじと見ることで「こんなに悪いのか」と実感し、治療意欲が高まります'
                        },
                        {
                            title: '補綴模型を使った体感説明',
                            description: '実際の補綴模型を患者様に触ってもらい、素材の価値を直感的に理解してもらいます。',
                            immediateSteps: [
                                '今日：現在の模型セットを確認（ジルコニア、e.max、銀歯の比較模型）',
                                '今週中：不足している模型を技工所に発注',
                                '患者様に渡す前に「こちらがジルコニア、こちらが銀歯です。重さや滑らかさを比べてみてください」のトーク練習',
                                '補綴模型専用の収納ケースを用意し、清潔感を保つ'
                            ],
                            tools: '補綴模型セット（ジルコニア、e.max、銀歯、金合金）、収納ケース',
                            tip: 'ジルコニアは銀歯より軽く滑らかです。触ってもらうと「これなら入れたい」と直感的に価値を理解されます'
                        },
                        {
                            title: '「お口の状態解説書」の作成・配布',
                            description: '口腔内写真に書き込みをした解説書を印刷し、患者様が自宅で家族と相談できるようにします。',
                            immediateSteps: [
                                '今日：PowerPointまたはCanvaで解説書テンプレートを作成',
                                '口腔内写真を貼り付け、問題箇所に矢印と説明を追記',
                                '今週中：2〜3名の患者様に試験的に配布しフィードバックを得る',
                                '診察券アプリがあれば、デジタル版で共有も検討'
                            ],
                            tools: 'PowerPoint/Canva、口腔内写真、プリンター',
                            tip: '「ご自宅でご家族と一緒にご検討ください」と渡すと、配偶者の同意も得やすくなります'
                        }
                    ]
                }
            ],
            ...
            critical: [
                {
                    ...
                    detailedActions: [
                        {
                            title: '即時架電ルールの徹底',
                            description: '予約時間を5〜10分過ぎても来院されない場合、その場ですぐに電話をかけるルールを全スタッフに徹底します。',
                            immediateSteps: [
                                '今日：受付スタッフに「5分過ぎたら電話」のルールを共有',
                                '今日：電話トークスクリプトを作成「○○様、本日ご予約いただいていたのですが、何かトラブルに遭われていないか心配でお電話しました」',
                                '今週中：各ユニットから受付が見える位置に時計を設置',
                                '来週から：毎日の無断キャンセル数と架電結果を終礼で報告'
                            ],
                            tools: '電話、トークスクリプト、記録シート',
                            tip: '「責める」のではなく「心配している」というスタンスで電話すると、患者様も再予約しやすくなります'
                        },
                        {
                            title: 'SMS/LINEでのフォロー体制',
                            description: '電話に出ない場合はSMSやLINEでメッセージを送り、確実に連絡が届くようにします。',
                            immediateSteps: [
                                '今日：SMS送信用のテンプレートを作成「○○歯科です。本日のご予約はいかがされましたでしょうか。ご都合が悪くなった場合は、お手数ですがご連絡ください」',
                                '今週中：LINE公式アカウントで個別メッセージ送信の運用ルールを決定',
                                '電話→SMS→LINE の順でフォローする流れを図解',
                                '無断キャンセル後3日以内に再連絡するリマインダーを設定'
                            ],
                            tools: 'SMS送信サービス、LINE公式アカウント',
                            tip: '1回の連絡で終わらせず、3日後に再度連絡することで復帰率がさらに上がります'
                        },
                        {
                            title: '無断キャンセル傾向の分析',
                            description: '無断キャンセルの回数、曜日、時間帯、患者属性を記録し、傾向を分析して対策を打ちます。',
                            immediateSteps: [
                                '今日：無断キャンセル記録シートを作成（日付、患者名、曜日、時間帯、治療内容、連絡結果）',
                                '今週から：毎日の無断キャンセルを記録開始',
                                '1ヶ月後：データを集計し「特に多い曜日・時間帯」を特定',
                                'リピーターには事前確認電話を追加するルールを策定'
                            ],
                            tools: 'スプレッドシート、分析グラフ',
                            tip: '同じ患者が3回以上無断キャンセルした場合、次回から当日予約のみに制限する等のルールも検討を'
                        }
                    ]
                },
                {
                    ...
                    detailedActions: [
                        {
                            title: '1週間前リマインドの設定',
                            description: '予約の1週間前に「変更がある場合はお早めにご連絡ください」というメッセージを自動送信します。',
                            immediateSteps: [
                                '今日：使用中の予約システムでリマインド自動送信機能があるか確認',
                                '今週中：1週間前リマインドのテンプレートを作成「○○様、○月○日のご予約確認です。変更がある場合は○○-○○○○までご連絡ください」',
                                '来週：自動送信設定を有効化し、テスト送信を実施',
                                'LINE公式アカウントがあれば、LINE経由のリマインドも設定'
                            ],
                            tools: '予約システムのリマインド機能、SMS送信サービス、LINE公式アカウント',
                            tip: '1週間前リマインドで早めにキャンセルの連絡をもらえれば、その枠を他の患者様に開放できます'
                        },
                        {
                            title: '前日リマインドの設定',
                            description: '予約の前日に「明日のご来院をお待ちしております」というメッセージを自動送信します。',
                            immediateSteps: [
                                '今日：前日リマインドのテンプレートを作成「○○様、明日○月○日○時のご予約を承っております。お気をつけてお越しください」',
                                '今週中：前日18時に自動送信される設定を有効化',
                                '来週：送信結果を確認し、開封率・到達率をチェック',
                                '場所や駐車場案内も含めると親切です'
                            ],
                            tools: '予約システム、SMS送信サービス',
                            tip: '前日リマインドは「明日だ！」と思い出させる効果があり、うっかり忘れによるキャンセルを大幅に減らせます'
                        },
                        {
                            title: '新患・長時間枠への確認電話',
                            description: '新患や1時間を超える自費診療枠は、2日前に確認の電話を入れてキャンセルを防ぎます。',
                            immediateSteps: [
                                '今日：アポイント帳で「新患」「1時間以上の自費枠」を確認できるマークを設定',
                                '今週中：確認電話のトークスクリプトを作成「○○様、○日のご予約確認でお電話しました。何かご不明な点はございますか？」',
                                '毎日の業務ルーティンに「2日後の新患・長時間枠への電話」を追加',
                                '受付担当者の業務分担表に明記'
                            ],
                            tools: '電話、アポイント帳、業務分担表',
                            tip: 'この電話で「実は質問があって…」と不安を解消できることも多く、キャンセル防止以上の効果があります'
                        }
                    ]
                }
            ],
