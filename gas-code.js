...
function sendDiagnosisEmail(data) {
  ...
  if (schedulingUrl) {
    var bannerHtml = '';
    if (bannerImageUrl) {
      bannerHtml = '<a href="' + schedulingUrl + '" target="_blank" style="display: block; margin-bottom: 16px;"><img src="' + bannerImageUrl + '" alt="無料相談のご案内" style="display: block; width: 100%; height: auto; margin: 0 auto;"></a>';
    }
